    ...
    <div>
      <footer className="bg-black text-white px-[4rem] py-[2rem]">
        ...
        <div className="pt-[4rem] flex">
          ...
          <div className="w-[35%]">
            <p className="font-[600] text-[1.2rem]">Other Locations</p>
            <ul className="pt-[2rem] flex flex-col gap-2">
              <li>
                <a href="/">Nigeria</a>
              </li>
              <li>
